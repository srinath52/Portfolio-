    ...
    <section className="py-20 md:py-32 relative bg-gradient-to-b from-day to-gray-200 dark:from-void dark:to-black theme-transition">
      <SectionWrapper className="max-w-5xl mx-auto px-6">
        ...
        <div className="mb-20 text-center">
            <h3 className="text-2xl font-bold mb-8 flex items-center gap-3 text-accent-day dark:text-neon-gold justify-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 text-center md:text-left border-t border-gray-300 dark:border-white/10 pt-16">
          ...
          <div className="flex flex-col justify-center space-y-6 md:pl-12">
             <motion.a 
                ...
                whileHover={{ x: 10 }}
                className="group flex items-center gap-4 text-gray-700 dark:text-gray-300 hover:text-neon-cyan transition-colors cursor-pointer justify-center md:justify-start"
             >
             ...
             <motion.div 
                whileHover={{ x: 10 }}
                className="group flex items-center gap-4 text-gray-700 dark:text-gray-300 hover:text-accent-day dark:hover:text-neon-gold transition-colors cursor-pointer justify-center md:justify-start"
             >
